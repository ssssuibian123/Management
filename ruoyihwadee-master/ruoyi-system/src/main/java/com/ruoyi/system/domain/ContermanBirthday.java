 ...
 * @date 2022-02-17
 */
public class ContermanBirthday extends BaseEntity
{
    ...
    @Excel(name = "生日时间", width = 30, dateFormat = "yyyy-MM-dd")
    private Date contermanBirthday;

    /** 居住地 */
    @Excel(name = "居住地")
    private String contermanPlace;
    ...
    public void setContermanBirthday(Date contermanBirthday) 
    {
        this.contermanBirthday = contermanBirthday;
    }

    public Date getContermanBirthday() 
    {
        return contermanBirthday;
    }
    public void setContermanPlace(String contermanPlace) 
    {
        this.contermanPlace = contermanPlace;
    }

    public String getContermanPlace() 
    {
        return contermanPlace;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("contermanBirthday", getContermanBirthday())
            .append("contermanPlace", getContermanPlace())
            .toString();
    }
}
